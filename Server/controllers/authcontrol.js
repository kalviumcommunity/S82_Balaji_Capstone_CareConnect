...
exports.googleAuthCallback = async (req, res) => {
  try {
    ...
    return res.redirect(`https://capstone-careconnect4.netlify.app/google-success?token=${token}`);
  } catch (error) {
    console.error("Google Auth Error:", error);
    res.redirect('https://capstone-careconnect4.netlify.app/google-failed');
  }
};
